...
.table-form tr > td:first-child {
	width: 110px; text-align: center; background: #f1f3f7 ; color:#243b73; font-weight: 600; 
}
...
.table-border thead { border-top: 2px solid #243b73 ;}
...
<main>
	<div class="body-container" style="width: 700px;">
		<div class="body-title">
			<h3><i class="fa-regular fa-square"></i> 게시판 </h3>
		</div>
