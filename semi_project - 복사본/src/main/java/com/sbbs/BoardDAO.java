...
public class BoardDAO {
	...
	public void insertBoard(BoardDTO dto) throws SQLException {
		...
		try {
			sql = "INSERT INTO sbbs(num, userId, subject, content, "
	...
	public int dataCount() {
		...
		try {
			sql = "SELECT NVL(COUNT(*), 0) FROM sbbs";
			pstmt = conn.prepareStatement(sql);
	...
	public int dataCount(String condition, String keyword) {
		...
		try {
			sql = "SELECT NVL(COUNT(*), 0) FROM sbbs b JOIN member1 m ON b.userId = m.userId ";
	...
	public BoardDTO readBoard(int num) {
		...
		try {
			sql = "SELECT num, b.userId, userName, subject, content, "
	...
	// 게시물 삭제
	public void deleteBoard(int num, String userId) throws SQLException {
		PreparedStatement pstmt = null;
		String sql;
